/* RPGAtlas — src/editor/core/workspace.ts
...
import { openPluginManager } from "../tools/plugins/plugin-manager";
import { openAudioManager } from "../tools/assets/audio-manager";
import { openDialogueWorkspace } from "../tools/content/dialogue-workspace";
import { openEventSearcher } from "../tools/content/event-searcher";
import { openResourceManager } from "../tools/assets/resource-manager";
import { openAssetBrowser } from "../tools/assets/asset-browser";
import { openCharGenerator } from "../tools/generators/character-generator";
import { openGeneratorHub } from "../tools/generators/generator-hub";
import { QUICK_GENERATOR_IDS, definitionById } from "../tools/generators/name-generator-data";
