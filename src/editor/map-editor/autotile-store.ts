/* RPGAtlas — src/editor/map-editor/autotile-store.ts
   ...
   shared runtime registry (src/shared/map/autotile-registry.ts), imports
...
import { syncAutotileRegistry } from "../../shared/map/autotile-load";
import type { TerrainKind } from "../../shared/map/terrain-kinds";
import { TILE } from "../core/editor-state";
