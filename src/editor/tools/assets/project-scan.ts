/* RPGAtlas — src/editor/tools/assets/project-scan.ts
   ...
   The plan (new / changed / missing) is the pure planScan (src/shared/assets/asset-scan.ts);
...
import { planScan, type ScannedFile } from "../../../shared/assets/asset-scan";
